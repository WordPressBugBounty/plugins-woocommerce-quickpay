	...
	public function init_form_fields(): void {
		$this->form_fields = [
			'enabled'     => [
				...
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Enable Swish payment', 'woocommerce-quickpay' ),
				'default' => 'no'
			],
			'_Shop_setup' => [
				'type'  => 'title',
			...
			'title'       => [
				...
				'default'     => esc_html__( 'Swish', 'woocommerce-quickpay' )
			],
			'description' => [
				...
				'default'     => esc_html__( 'Pay with Swish', 'woocommerce-quickpay' )
			],
		];
	}
