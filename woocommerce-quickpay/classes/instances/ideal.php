	...
	public function init_form_fields(): void {
		$this->form_fields = [
			'enabled'     => [
				...
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Enable iDEAL payment', 'woocommerce-quickpay' ),
				'default' => 'no'
			],
			'_Shop_setup' => [
				'type'  => 'title',
			...
			'title'       => [
				...
				'default'     => esc_html__( 'iDEAL', 'woocommerce-quickpay' )
			],
			'description' => [
				...
				'default'     => esc_html__( 'Pay with iDEAL', 'woocommerce-quickpay' )
			],
		];
	}
